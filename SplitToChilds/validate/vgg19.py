...
import drivers
from ModelFuntionsPython.childs.vgg19 import *
from ModelFuntionsPython.raw.vgg19 import *
from config import Config
...
def run_whole_model_from_onnx():
    ...
    mod, params, _ =easy_load_from_onnx(model_name,shape_dict,download_url=OnnxModelUrl.Vgg19,validate_download=False)
