...
import drivers
from ModelFuntionsPython.childs.squeezenetv1 import *
from ModelFuntionsPython.raw.squeezenetv1 import *
from config import Config
...
def run_whole_model_from_onnx():
    ...
    mod, params, _ =easy_load_from_onnx(model_name,shape_dict,download_url=OnnxModelUrl.SqueezeNetv1,validate_download=False)
