...
def GoogleNetModule_2():
    ...
    call_10 = relay.var("call_10", shape=(1, 192, 56, 56), dtype="float32")
...
def GoogleNetModule_3():
    ...
    call_205 = relay.var("call_205", shape=(1, 1024, 1, 1), dtype="float32")
    loss3_classifier_w_0 = relay.var("loss3/classifier_w_0", shape=(1, 1024, 1, 1), dtype="float32")
    loss3_classifier_b_0 = relay.var("loss3/classifier_b_0", shape=(1000, 1024), dtype="float32")

    call_207 = relay.reshape(call_205, newshape=[1, 1024])
