...
def Module():
    part1_input = relay.var("part1_input", shape=(4, 3, 14, 14, ), dtype="float32")
    ...
    call_0 = relay.nn.conv2d(part1_input, weight1, strides=[2, 2], padding=[0, 0, 0, 0], channels=1, kernel_size=[4, 4])
    call_1 = relay.nn.bias_add(bias1, call_0, )
    call_2 = relay.add(part1_input, add1, )
    call_3 = relay.nn.conv2d(weight2, call_2, strides=[2, 2], padding=[0, 0, 0, 0], channels=1, kernel_size=[4, 4])
    call_4 = relay.nn.bias_add(bias2, call_3, )
