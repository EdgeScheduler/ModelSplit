...
from AutoGenIRModule.pyfile.vgg19_split.vgg19_0 import Vgg19Module_0
from AutoGenIRModule.pyfile.vgg19_split.vgg19_1 import Vgg19Module_1
from AutoGenIRModule.pyfile.vgg19_split.vgg19_2 import Vgg19Module_2
from AutoGenIRModule.pyfile.vgg19_split.vgg19_3 import Vgg19Module_3
...
def run_split_model_N(params_file_path=None, parts=1):
    ...
    for part in range(parts):
        ...
        if part == 0:
            ir_module1 = tvm.IRModule.from_expr(Vgg19Module_0())
        elif part == 1:
            ir_module1 = tvm.IRModule.from_expr(Vgg19Module_1())
        elif part == 2:
            ir_module1 = tvm.IRModule.from_expr(Vgg19Module_2())
        elif part == 3:
            ir_module1 = tvm.IRModule.from_expr(Vgg19Module_3())
        with tvm.transform.PassContext(opt_level=3):
...
if __name__ == '__main__':
    ...
    run_whole_model()
    params_file_path = "/home/onceas/wanna/ModelSplit/AutoGenIRModule/text/vgg19_split/params.json"
...
[-0.89078444  0.58848685  2.3871887   0.9814049   0.9739352   0.1816515
  0.502313   -1.0489405  -0.9700336  -1.0954674 ]
[-0.89078444  0.58848685  2.3871887   0.9814049   0.9739352   0.1816515
  0.502313   -1.0489405  -0.9700336  -1.0954674 ]
[-0.89078444  0.58848685  2.3871887   0.9814049   0.9739352   0.1816515
  0.502313   -1.0489405  -0.9700336  -1.0954674 ]
