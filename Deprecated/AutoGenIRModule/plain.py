    ...
    with open(relay_text_path, 'r') as f:
        ...
        for line in f:
            ...
            # 2: "  %7 = %3.0;\n" or "%99 = (%97, %98);"
                ...
                bottoms = [
                    "call_"+bottom if bottom not in net_inputs else bottom for bottom in bottoms]
                ...
                if "meta[relay.Constant]" in line:
                    ...
                    constant_shape = [i.split("ty=Tensor[")[1].split(
                        "), ")[0]+')' for i in line.split("meta[relay.Constant]")[1:]]
                    ...
                    if "Constant" in b:
                        if "int" in net_meta_dtypes[b]:
                            relay_python.write("    {} = relay.const(np.random.randint(0, 10, ({})), dtype=\"{}\")\r".format(
                                b, net_meta_shapes[b].strip('(').strip(')'), net_meta_dtypes[b]))
                        else:
